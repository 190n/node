These files are copied from https://github.com/190n/node/tree/napi-tests-bun/test, which in turn is a fork of Node.js with their js-native-api tests modified slightly to work in Bun.
